namespace CTF_int{
  ...
  double red_mdl_init[] = {4.5530E-11, 3.0466E-17, 6.25E-9}; // mpi_reduce, used for summa for moving C 
  ...
  double bcast_mdl_init[] = {1.1115E-16, 1.0754E-16, 3.3333E-9}; //mpi_bcast, used for summa for bcasting A,B, 3rd parameter is around 0.3 GB/s
  ...
  double seq_tsr_ctr_mdl_inr_init[] = {6.0166E-21, 2.3443E-13, 3.3333E-11}; // our model, 2nd parameter negligible for large matrices, 3rd paramter fixed to 30GFLOPS/s/core
